...
export default function TicketTable({ data }: Props) {
  ...
  const columnHeadersArray: Array<keyof TicketWithCustomer> = [
    "ticketDate",
    "title",
    "tech",
    "firstName",
  ...
  const columnHelper = createColumnHelper<TicketWithCustomer>();
  ...
  return (
    <div className="mt-6 flex flex-col gap-4">
      ...
      <div className="flex justify-between items-center gap-5 flex-wrap mb-10">
        <div>
